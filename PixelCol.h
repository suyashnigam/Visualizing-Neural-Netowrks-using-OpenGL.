...
public:
	...
	double** Downsample(const int size, const int dScale);    //downsample the drawn image to a 28x28 array for imput to the neural network
	void MouseEventLooping(int bX, int sizeInp, int bY, int lb, int mb, int rb, int mx, int my,int &flag);
};
